...
public interface GimnasioRepository extends JpaRepository<Gimnasio, Integer>{
    ...
    @Modifying
    @Transactional
    @Query(value = "INSERT INTO gimnasio (horainicio, horafin, secobra, hotel_id) VALUES (:horainicio, :horafin, :secobra, :hotel_id)", nativeQuery = true)
    void insertarGimnasio(@Param("horainicio") Integer horainicio, @Param("horafin") Integer horafin, @Param("secobra") Boolean secobra, @Param("hotel_id") Integer hotel_id);
    ...
    void actualizarGimnasio(@Param("id") Integer id, @Param("horainicio") Integer horainicio, @Param("horafin") Integer horafin, @Param("secobra") Boolean secobra, @Param("hotel_id") Integer hotel_id);
