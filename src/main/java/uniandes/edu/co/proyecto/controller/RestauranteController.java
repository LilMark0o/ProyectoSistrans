...
public class RestauranteController {
    ...
    @GetMapping("/{id}")
    public ResponseEntity<Restaurante> obtenerRestaurantePorId(@PathVariable Integer id) {
    ...
    public ResponseEntity<Restaurante> crearRestaurante(@RequestBody Restaurante restaurante) {
        restauranteRepository.insertarRestaurante(restaurante.getId(), restaurante.getHotel().getId());
